...
@Component({
  selector: 'app-list-school-fees',
  templateUrl: './list-school-fees.component.html',
  styleUrls: ['./list-school-fees.component.scss']
})
export class ListSchoolFeesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this._financeService.listSchoolFees().subscribe(data=>{
